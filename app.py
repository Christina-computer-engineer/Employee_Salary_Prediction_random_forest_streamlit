...
# target_encoder = joblib.load("target_encoder.pkl")  # optional

# st.title("🧑‍💼 Employee Salary Prediction")
# st.markdown("Enter employee details below to predict whether the income is >50K or <=50K")

# # Input fields
# age = st.number_input("Age", min_value=18, max_value=100, step=1)
# fnlwgt = st.number_input("Fnlwgt (Final Weight)", min_value=1, step=1)
...
#     # Output
#     if prediction == 1:
#         st.success(f"✅ Predicted Salary: {result_label}")
#     else:
#         st.warning(f"❌ Predicted Salary: {result_label}")
...
# st.markdown("---")
# st.subheader("📊 Model Evaluation and Visualizations")

# if st.checkbox("Show Model Performance Graphs"):
...
#     sns.countplot(data=comparison_df, x='Actual', hue='Predicted', ax=ax2, palette="Set2")
#     ax2.set_title("Actual vs Predicted Income")
#     st.pyplot(fig2)
